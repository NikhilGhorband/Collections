namespace CollectionsProblem
{
    internal class Program
    {
        static void Main(string[] args)
        {
            int N = 4; // Total number of the chapters
            int[,] chapters = { { 1, 4 }, { 5, 7 }, { 9, 16 }, { 17, 26 } }; // Start and end pages of each chapter given in problem
            int K = 7; // Current reading page

            int remainingChapters = CountRemainingChapters(N, chapters, K);
            Console.WriteLine("Number of chapters Remaining to read: " + remainingChapters);
        }
